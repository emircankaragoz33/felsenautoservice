                ...
                <div className="footer-cols">
                    <div>
                        ...
                        <div style={{ marginTop: '15px' }}>
                            <a href="https://instagram.com/felsenservis" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', fontSize: '1.5rem', transition: 'color 0.3s' }} className="social-link">
